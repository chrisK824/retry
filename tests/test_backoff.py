...
@pytest.mark.parametrize("initial_delay, jitter", [
    (1.0, None),
    (1.0, (0.1, 0.5)),
    (0.0, None),
    (0.0, (0.0, 0.0)),
...
@pytest.mark.parametrize("initial_delay, step, jitter", [
    (1.0, 0.5, None),
    (1.0, 0.5, (0.1, 0.5)),
    (0.0, 0.0, None),
    (0.0, 0.0, (0.0, 0.0)),
...
@pytest.mark.parametrize("initial_delay, min_delay, max_delay", [
    (1.0, 0.5, 2.0),
    (1.0, 3.4, 5.6),
    (0.0, 0.0, 0.0),
])
